...
| [J3](J3-conciliar-reentrega.md) | Match reentrega ↔ OC/IN | ZDRY | **Cerrado** 20-sep-2026 · [reto](j3_reto.md) · [sprints A–E](j3_reto_sprints.md) |
| [J4](J4-foto-unica.md) | Una foto de referencia a Odoo | ZDRY | En curso 20-sep-2026 |
...
Negocio: `implicancias_integrar_odoo.md`, `caso_aplicacion.md`. Patio/coordinador: `plan_ajuste.md` (A–F, ya en código). Integración lectura F0–F5: `fase_integracion_odoo.md` (hecha; F6 la absorbe J2/J6). Cotización DRY: [cotizacion_dry.md](../cotizacion_dry.md). Patrones de 500 SO + plan WA: [datos_dry.md](../datos_dry.md).
