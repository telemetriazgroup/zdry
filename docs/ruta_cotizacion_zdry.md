...
**Q0–Q4b hechos.** Venta: SO draft + PDF Perú v2 + pedido (voucher) + enmienda en draft. Alquiler no emite SO (Q6). **No implementa J5/`sale_close`.**
...
| Q4b | No | write SO draft; 409 si `sale` |
