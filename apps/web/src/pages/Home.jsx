  ...
  return (
    <>
      ...
      <p className="section-sub" style={{ marginTop: 16 }}>
        ...
        {user.role === "superadmin" ? " Desde el menú configuras Odoo, traes la estadística DRY 2025–2026, buscas lotes a la mano, editas textos del catálogo y gestionas respaldos." : ""}
